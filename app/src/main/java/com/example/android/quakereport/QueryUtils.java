...
public final class QueryUtils {
    ...
    private static String readFromStream(InputStream inputStream) throws IOException {
        ...
        Log.v("readFromStream","jsonResponse: " + output.toString());
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(String inputUrl) {
        URL queryUrl = createUrl(inputUrl);
        String jsonResponse = "";
        try {
        ...
        Log.i("QueryUtils.java", "jsonResponse: " + earthquakes.toString());
        return earthquakes;
    }
